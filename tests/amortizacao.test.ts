import { Amortizacao, PeriodoAmortizacao } from "../src/scripts/models/amortizacao";
...
describe("Amortizacao", () => {
	...
	describe("serialization", () => {
		test("should serialize and deserialize MonthlyAmortization", () => {
		...
		test("should serialize and deserialize CustomAmortization", () => {
			...
			expect((restored as any).termMonths).toBe(20);
		});
	});
});
